...
L<Synopsis 9: Structures de données|"Synopsis 9: Structures de données">
...
=head2 L<Synopsis 9: Structures de données|https://github.com/perl6/specs/blob/master/S09-data.pod>
=head1 Références
