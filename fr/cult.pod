...
=item L<Synopsis 1: vue d'ensemble|https://github.com/perl6/specs/blob/master/S01-overview.pod>

Ce document résume à l'origine l'Apocalypse 1, ce qui couvre les concepts (design), les concepts initiaux.
...
=item L<Synopsis 2: Bits and Pieces|https://github.com/perl6/specs/blob/master/S02-bits.pod>

Ce document résume l'Apocalypse 2, qui couvre des articles lexicaux de petites tailles et des questions typologiques. Ces 
